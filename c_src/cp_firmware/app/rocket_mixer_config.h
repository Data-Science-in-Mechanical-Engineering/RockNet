...
static const uint8_t nodes[] = {  1,  2,  3,  4,  5,  6, };
static const uint8_t rocket_nodes[] = {  1,  2,  3,  4,  5, };
...
#define ROUND_LENGTH_MS            ((MX_ROUND_LENGTH*MX_SLOT_LENGTH / (GPI_HYBRID_CLOCK_RATE / 1000000)) / 1000 + 412)
#define MX_GENERATION_SIZE 7
